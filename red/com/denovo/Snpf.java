...
//load data in low efficiency
//	public boolean snpinput() {
//		try {
//			System.out.println("snpinput start"+" "+df.format(new Date()));// new Date()为获取当前系统时间
//			db.usedb();
//			int ts_count=0;
//			sql[0] = "drop table if exists SnpVcf";
//			db.result = db.stmt.executeUpdate(sql[0]);
//			sql[1] = "create table SnpVcf(chrome varchar(15),pos varchar(30))";
//			db.result = db.stmt.executeUpdate(sql[1]);
//			db.con.commit();
...
//					continue;
//				}
//				sql[2] = "insert into SnpVcf values('" + line.split("\\t")[0]
//						+ "','" + line.split("\\t")[1] + "')";
...
//			}
//			db.con.commit();
//			System.out.println("snpinput end"+" "+df.format(new Date()));// new Date()为获取当前系统时间
//		} catch (IOException e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//			return false;
...
//			sql[0] = "select chrome,pos from dnarnatemp";
			sql[0] = "select chrome,pos from comphrehensivetemp";
