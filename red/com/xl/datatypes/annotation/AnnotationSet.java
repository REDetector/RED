...
public class AnnotationSet {
	 ...
	 * 
	 * @param genome
	 *            The base genome which this annotation applies to
	 * @param name
	 *            The name for the set (file name, URL etc)
	 */
	 ...
	 * 
	 * @param collection
	 *            The AnnotationCollection to which this set has been added
	 */
