...
import com.xl.utils.FileFilterExt;
...
public class REDApplication extends JFrame implements ProgressListener,
	 ...
	 * 
	 * @param genome
	 *            The Genome which has just been loaded.
	 */
	 ...
	 * 
	 * @param parser
	 *            A DataParser which will actually do the importing.
	 */
	 ...
	 * 
	 * @param baseLocation
	 *            The folder containing the requested genome.
	 */
	 ...
	 * 
	 * @param file
	 *            The file into which the project will be saved
	 */
	 ...
	 * 
	 * @param d
	 *            The set of dataStores to display
	 */
