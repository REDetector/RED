...
public class BAMFileParser extends DataParser {
	 ...
	 *            The dataCollection to which new data will be added.
	 */
	 ...
	 * @param data
	 *            The dataCollection to which new data will be added.
	 * @param pairedEndImport
	 *            Whether to import this as paired end data
	 * @param pairedEndDistanceCutoff
	 *            The maximum distance (bp) between valid paired ends
	 * @param splitSplicedReads
	 *            Whether to split up spliced reads into their component parts
	 */
	 ...
	 * 
	 * @param samRecord
	 *            The picard record entry for this read
	 ...
	 * 
	 * @param sections
	 *            The tab split sections from the SAM file
	 * @param flag
	 *            The binary flag field from the file
	 * @return The read which was read
	 * @throws REDException
	 */
...
//		}
		...
		try {
			...
			throw new REDException(iae.getLocalizedMessage());
		}
