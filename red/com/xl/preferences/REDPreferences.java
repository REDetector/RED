...
//	private String genomeDownloadLocation = "http://www.bioinformatics.babraham.ac.uk/seqmonk/genomes/";
	...
	private File projectRootDirectory = new File("");// ²ÎÊýÎª¿Õ
...
//			System.out.println("loadPreferences();");
	 ...
	 * @param port
	 *            The port to access the proxy on
	 */
		...
		if (genomeBase == null) {
			...
			try {
				...
				if (!f.exists()) {
					...
					System.err.println("Couldn't find default Genomes folder");
					return null;
				}
			} catch (Exception e) {
				e.printStackTrace();
	 ...
	 * 
	 * @param url
	 *            The URL under which new genomes can be downloaded
	 */
	 ...
	 * 
	 * @param f
	 *            The folder under which new genomes should be stored
	 */
	 ...
	 * 
	 * @param f
	 *            The new last used data location
	 */
