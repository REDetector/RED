...
public abstract class Report implements Runnable, Cancellable {
    ...
    /**
     * Gets a panel which both displays and allows the user to set whatever options the report has.
     *
    ...
    /**
     * Says if enough options have been set to allow the report to be generated.
     *
