...
public class REDMenu extends JMenuBar implements ActionListener {
	 ...
	 * 
	 * @param jMenu
	 *            The menu which should add to.
	 * @param jMenuItem
	 *            The menu item to be added to the jMenu.
	 * @param text
	 *            The menu item name, including the action command name.
	 * @param mnemonic
	 *            The keyboard shortcuts. Call Java API when using the shortcut
	 *            letter.
	 */
