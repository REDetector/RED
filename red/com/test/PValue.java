...
//		float[] P_V;
    ...
    public void loadHg19() {
        try {
            System.out.println("loadhg19 start" + " " + df.format(new Date()));// new Date()Ϊ��ȡ��ǰϵͳʱ��
            db.usedb();
            // ��ʼ��
            int count_ts = 0;
            ...
            System.out.println("loadhg19 end" + " " + df.format(new Date()));// new Date()Ϊ��ȡ��ǰϵͳʱ��
...
//				double[][] data=new double[][]{{51.2,49.3},{100.,0}};
    ...
    public void P_V(String commandD) {
        System.out.println("P_V start" + " " + df.format(new Date()));// new Date()Ϊ��ȡ��ǰϵͳʱ��
        pvTable();
        Exp_num();
...
//				System.out.println(chr+" "+ps+" "+(int)found_ref[i]+" "+(int)found_alt[i]+" "+dF.format(lev)+" "+pvalue);
        ...
        System.out.println("P_V end" + " " + df.format(new Date()));// new Date()Ϊ��ȡ��ǰϵͳʱ��
    }
