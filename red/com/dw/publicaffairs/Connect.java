...
public class Connect {
	/**
	 * @param args
	 *            The following is for non-denovo detection. arg[0]: true if
	 ...
	 * 
	 *            The following is for denovo detection arg[0]: true if denovo
	 *            arg[1]: RNA vcf file arg[2]: Repeat file from
	 *            http://www.repeatmasker.org/PreMaskedGenomes.html arg[3]: Ref
	 *            Seq Genes from http://genome.ucsc.edu/cgi-bin/hgTables arg[4]:
	 *            dbSNP file FROM http://www.ncbi.nlm.nih.gov/SNP/ arg[5]:
	 *            DARNED database FROM
	 *            http://darned.ucc.ie/static/downloads/hg19.txt arg[6]: The
	 *            path of RScript arg[7]: Column index of vcf file to select
	 *            normal or cancer people arg[8]: The database name.
	 */
	public static void main(String[] args) {
		...
		if (!isDenovo) {
			...
			df.dnaVcf(DatabaseManager.DNA_VCF_RESULT_TABLE_NAME, args[2],
			...
			df.RnaVcf(DatabaseManager.RNA_VCF_RESULT_TABLE_NAME, args[1],
					Integer.parseInt(args[8]));
